odoo.define('hcs_bm_ecovis.remove_export_option', function (require) {
"use strict";
...
var _lt = core._lt;
    Sidebar.include({
        start: function () {
            ...
            def = this.getSession().user_has_group('hcs_bm_ecovis.group_hide_export').then(function(has_group) {
                if (!has_group)
                {
