...
class BM_OfficialSalary_Files(http.Controller):
    ...
    def create_file_txt(self, req):
        ...
        # Creo el PDF
        report = req.env.ref('hcs_bm_ecovis.bm_official_salary_report')
    ...
    def create_departure_report(self, req):
        ...
        # Creo el PDF
        report = req.env.ref('hcs_bm_ecovis.bm_official_departure_note_report')
    ...
    def create_account_report(self, req, ids):
        ...
        report = req.env.ref('hcs_bm_ecovis.bm_official_account_report')
